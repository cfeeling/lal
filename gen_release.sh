...
echo 'github: https://github.com/cfeeling/lal' >> ${ROOT_DIR}/${OUT_DIR}/${prefix}linux/README.txt
echo 'github: https://github.com/cfeeling/lal' >> ${ROOT_DIR}/${OUT_DIR}/${prefix}macos/README.txt
echo 'github: https://github.com/cfeeling/lal' >> ${ROOT_DIR}/${OUT_DIR}/${prefix}windows/README.txt
